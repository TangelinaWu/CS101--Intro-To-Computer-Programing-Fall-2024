...
/**take input of scanner, if  space = comma create an arraylist, and put all the words in it
 * print ask user which words they want to check and iterate for
 * scan the word, for all the words test it for blank word and add it to counter 
 * return number 
    ...
    public static String getFilepathFromUser() {
        ...
        return ""; // replace this line by the actual return
    }
    ...
    public static String[] getTicsFromUser() {
        return new String[] {}; // TODO dummy return, remove it!
    }
    ...
    public static int countOccurrences(String needle, String haystack) {
        return -1; // TODO dummy return, remove it!
    }
